...
# Load images
menu_background = pygame.image.load(r"F:\codes\Screenshots\Screenshot 2025-05-27 203546.png").convert()
menu_background = pygame.transform.scale(menu_background, (750, 600))

sky_image = pygame.image.load(r"C:\Users\Sumiran Swaroop\OneDrive\Desktop\Game\graphics\Screenshot 2025-05-27 204941.png").convert()
sky_image = pygame.transform.scale(sky_image, (750, 500))

ground_image = pygame.image.load(r"C:\Users\Sumiran Swaroop\OneDrive\Desktop\Game\graphics\Screenshot 2025-05-27 205212.png").convert()
ground_image = pygame.transform.scale(ground_image, (750, 100))

player_image = pygame.image.load(r"C:\Users\Sumiran Swaroop\OneDrive\Desktop\Game\graphics\player_final.png").convert_alpha()
player_image = pygame.transform.scale(player_image, (50, 100))
player_rect = player_image.get_rect(midbottom=(100, 500))

enemy_image = pygame.image.load(r"C:\Users\Sumiran Swaroop\OneDrive\Desktop\Game\graphics\enemy_final.png").convert_alpha()
